...
type ProofPhotoWallProps = { proofs: CompletionProof[]; maxPhotos?: number };
...
function createStyles(theme: AppTheme) {
  return StyleSheet.create({
    ...
    frame: { overflow: 'hidden', borderColor: theme.border, borderRadius: radius.medium, borderWidth: 1, backgroundColor: theme.surfaceAlt },
    featuredFrame: { borderColor: theme.accent, borderWidth: 2 },
    image: { width: 82, height: 82, backgroundColor: theme.surfaceAlt },
    emptyText: { ...typography.body, color: theme.textMuted, lineHeight: 22 },
  });
}
